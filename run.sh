...
echo "----------安装完成------";
echo "----------生成脚本------";
echo "autossh -f -N -M $port_listen -R 0.0.0.0:$port_serve:$ip_sbox:$port_sbox -o StrictHostKeyChecking=no -i $path/id_rsa_drop  root@$ip_serve >$path/log 2>$path/autossh_log" >autossh.sh
